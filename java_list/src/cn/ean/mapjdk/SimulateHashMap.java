...
public class SimulateHashMap<K,V> extends AbstractMap<K,V>
     ...
     */
    public SimulateHashMap(int initialCapacity) {
     ...
     * @param m
     */
    public SimulateHashMap(Map<? extends K, ? extends V> m) {
        this.loadFactor = DEFAULT_LOAD_FACTOR;
    ...
    static final class TreeNode<K,V> extends SimulateLinkedHashMap.Entry<K,V> {
         ...
         * this node.
         */
        final Node<K,V> untreeify(SimulateHashMap<K,V> map) {
         ...
         */
        final TreeNode<K,V> putTreeVal(SimulateHashMap<K,V> map, Node<K,V>[] tab,
                                               int h, K k, V v) {
            Class<?> kc = null;
         ...
         */
        final void removeTreeNode(SimulateHashMap<K,V> map, Node<K,V>[] tab,
                                  boolean movable) {
            int n;
         ...
         */
        final void split(SimulateHashMap<K,V> map, Node<K,V>[] tab, int index, int bit) {
            TreeNode<K,V> b = this;
